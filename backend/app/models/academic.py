...
class Faculty(Base):
    ...
    name = Column(String, nullable=False, unique=True)  # e.g. "School of Computing & IT"
    code = Column(String, nullable=False, unique=True)   # e.g. "SCIT"
...
class Department(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String, nullable=False)  # e.g. "Software Engineering"
    code = Column(String, nullable=False)  # e.g. "SEN"
...
class Level(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String, nullable=False)  # e.g. "100", "200"
...
class Semester(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    name = Column(String, nullable=False)  # e.g. "First", "Second"
...
class Course(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    code = Column(String, nullable=False)   # e.g. "MTH 101"
    title = Column(String, nullable=False)  # e.g. "Elementary Mathematics I"
